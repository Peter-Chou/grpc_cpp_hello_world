...
# Import target "gRPC::grpc_csharp_ext" for configuration ""
set_property(TARGET gRPC::grpc_csharp_ext APPEND PROPERTY IMPORTED_CONFIGURATIONS NOCONFIG)
set_target_properties(gRPC::grpc_csharp_ext PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_NOCONFIG "dl;rt;m;pthread;gRPC::grpc;gRPC::gpr"
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libgrpc_csharp_ext.so"
  IMPORTED_SONAME_NOCONFIG "libgrpc_csharp_ext.so"
  )
